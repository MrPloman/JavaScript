...
function createCar(plate, color, brand) {
    ...
    var diamWheel1 = parseFloat(document.getElementById("DiamWheel1").value);
    var wheel2 = document.getElementById("Wheel2").value;
    var diamWheel2 = parseFloat(document.getElementById("DiamWheel2").value);
    var wheel3 = document.getElementById("Wheel3").value;
    var diamWheel3 = parseFloat(document.getElementById("DiamWheel3").value);
    var wheel4 = document.getElementById("Wheel4").value;
    var diamWheel4 = parseFloat(document.getElementById("DiamWheel4").value);
    ...
    if (!plateValidation) {
        ...
        if ((diamWheel1 > 2) || (diamWheel2 > 2) || (diamWheel3 > 2) || (diamWheel4 > 2) || (diamWheel1 < 0.4) || (diamWheel2 < 0.4) || (diamWheel3 < 0.4) || (diamWheel4 < 0.4)) {
            ...
            if ((isNaN(car.wheels[0].diameter)) || (isNaN(car.wheels[1].diameter)) || (isNaN(car.wheels[2].diameter)) || (isNaN(car.wheels[3].diameter))) { // que obligue a introducir un valor a cada diámetro
                ...
                var recuadre = document.getElementById("recuadre");
